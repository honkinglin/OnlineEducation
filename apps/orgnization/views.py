    ...
    def post(self, request):
        ...
        if exist_records:
            ...
            if int(fav_id) > 0 and int(fav_type) > 0:
                ...
                user_fav.save()
                return HttpResponse('{"status":"success", "msg":"Favorited"}', content_type='application/json')
            else:
                return HttpResponse('{"status":"fail", "msg":"Favorite Error"}', content_type='application/json')
